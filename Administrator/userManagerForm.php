...
if (isset($_POST['sumbit'])) {
    ...
    $stmt_user="SELECT * from adminmanageraccount where email='$email'" ;
    ...
    if ($result->num_rows>0) {
        ...
        $sql="INSERT INTO adminmanageraccount (managerName,manageremail,managermobile,password) VALUES('$name','$email','$mobile','$password' )";
...
<body>
    <div class="container my-5">
        <form method="POST">
            ...
            <div class="form-group">
                <label class="form-label"> Mnager mobile:</label>
