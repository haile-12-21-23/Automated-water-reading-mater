...
$id=$_GET['updateid'];
$sql="SELECT *FROM adminbillofficeraccount where BOID=$id";
...
if (isset($_POST['submit'])) {
    ...
    $sql="update adminbillofficeraccount set BOID=$id,officerName='$name',mobile='$mobile',email='$email',password='$password' where BOID=$id ";
    $result=$connect->query($sql);
    if ($result) {
