...
$id=$_GET['updateid'];
$sql="SELECT *FROM adminaccount where AID=$id";
...
if (isset($_POST['submit'])) {
    ...
    $sql="update adminaccount set AID=$id,adminName='$name',adminEmail='$email',adminMobile='$mobile',password='$password' where AID=$id ";
    $result=$connect->query($sql);
    if ($result) {
