...
if (isset($_POST['sumbit'])) {
    ...
    $stmt_user="SELECT * from adminpersonalaccount where mobile='$mobile'" ;

    $result=$connect->query($stmt_user);
    if ($result->num_rows>0) {
    
 echo "mobile number already exist";
        header('Location:userPersonalForm.php');
    } else {
        $sql="INSERT INTO adminpersonalaccount (fullName,mobile,password) VALUES('$name','$mobile','$password' )";
