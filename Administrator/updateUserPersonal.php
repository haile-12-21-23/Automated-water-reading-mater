...
$id=$_GET['updateid'];
$sql="SELECT *FROM adminpersonalaccount where PID=$id";
...
$sql="update adminpersonalaccount set PID=$id,fullName='$name',mobile='$mobile',password='$password' where PID=$id ";
$result=$connect->query($sql);
if ($result) {
