...
<body class="bg-success p-2" style="--bs-bg-opacity: .5;">
        ...
        <form action="" method="POST" class="mb-3 ">
            <div class="input-group">
                <select name="account">
                    ...
                    <option value="4">Bill officer</option>
                    <option value="5">Manger</option>
                    <option value="6">Maintenance worker</option>
                    <option value="7">Administrator</option>
                </select>
                <input type="submit" class="btn btn-secondary p-2.7 m-3" name="submit" value=" create account">
        </form>
        <table class="table">
            <thead>
                <tr>
    ...
    if (isset($_POST['submit'])) {
        if (!empty($_POST['account'])) {
            ...
            echo '<p class="text-danger">Please select The user type to create account.</p>';
        }
    }
?>
