...
if (isset($_POST['sumbit'])) {
    ...
    $stmt_user="SELECT * from adminaccount where adminEmail='$email'" ;
    ...
    if ($result->num_rows>0) {
        ...
        $sql="INSERT INTO adminaccount (adminName,adminEmail,adminMobile,password) VALUES('$name','$email','$mobile','$password' )";
