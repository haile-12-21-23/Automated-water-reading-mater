...
<head>
    ...
    <title>
        Pubilc and governmental Bill record details
    </title>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Pubilc and governmental Bill record details
                        <a href="publicBillReport.php" class="btn btn-danger float-end">Back</a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM billrecordpublic where No=$id";
