...
<head>
    ...
    <title>print all public bill Reports</title>
                ...
                <div class="card">
                    ...
                    <table id="ready" class="table table-striped table-boardered" style="width: 100%;">
                        <div class="card-header">
                            <h4>Public and governmental institution Bill record dedails
                                <a href="publicBillReport.php" class="btn btn-danger float-end">Canlce </a>
