...
<form>
      <div id="private" class="private-information">
            ...
            <label style="font-size:24px;font-family:Times New Roman;font-weight: bold;"> Organazation Phone Number: </label>   
            <input type="text" name="middlename" placeholder="Middlename" size="15" required />   
            <label style="font-size:24px;font-family:Times New Roman;font-weight: bold;"> Organization Address: </label>    
            <input type="text" name="lastname" placeholder="Lastname" size="13"required />   
            <button style="font-size:24px;font-family:Times New Roman;font-weight: bold;" type="submit" class="registerbtn">Register</button> 
      </div>


      <div id="public" class="public-information">
            <h3 style="font-size:26px;font-family:Times New Roman;font-weight: bold;text-align: center;">Institution Information</h3>
            ...
            <label style="font-size:24px;font-family:Times New Roman;font-weight: bold;"> Institution Phone Number: </label>   
