...
$pid = $_GET['mid'];
$sql = "SELECT insname ,insphone  FROM registerpublic where GID=$pid
    ";
...
<body>
    <div class="form-container">
        <form action="" method="post">
            ...
            <label class="form-label text-start fs-5 w-100 bg-opacity-10 mx-2">Institution Name</label>
            ...
            <a class="text text-decoration-none" href="statusPiblic.php? sid=<?php echo $sid ?>">View previous
                status</a>
        </form>
    </div>
