...
$pid = $_GET['mid'];
$sql = "SELECT orgname ,orgphone  FROM registerprivate where OID=$pid
    ";
...
$id=$row_id['Id'];
            ...
            ?>
            <label class="form-label text-start fs-5 w-100 bg-opacity-10 mx-2">Organization Name</label>
            ...
            <p> <a class="text text-decoration-none mt-1" href="statusPrivate.php? mid=<?php echo $id ?>">View
                    previous
                    status</a></p>
