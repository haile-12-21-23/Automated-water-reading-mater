...
<body class="bg-success p-2" style="--bs-bg-opacity: .5;">
    ...
    <div class=" container mx-5 mx-auto w-50">
        <form action="" method="POST" class="mb-3 ">
            <div class="input-group">
                ...
                <input type="submit" class="btn btn-dark mx-3 rounded-pill" name="submit" value="Select customer">
        </form>
    ...
    if (isset($_POST['submit'])) {
        if (!empty($_POST['account'])) {
            ...
            if ($selected == 1) {
                header('Location:registerPersonalCustomer.php');
            } elseif ($selected == 2) {
